...
const About = () => {
  ...
  return (
    <div className='mt-28 px-[5%]'>
        ...
        Proficient in ReactJs and Tailwind CSS, the C# language using Asp.Net Framework.
        Ada's journey as a web developer began with a fascination for how websites work, leading her to master various programming languages and frameworks. Her commitment to continuous learning ensures that she stays up-to-date with industry trends and best practices. Ada is proficient in using React and Vite to build dynamic, responsive web applications, and she has a strong foundation in HTML, CSS, JavaScript and C#.</p>
        </div>
    </div>
  )
}
